...
class UndergraduateDirectoryListFilter(filters.FilterSet):
    class_years = MultiValueCharFilter(field_name="class_year__class_year", lookup_expr='iexact')
    tracks = MultiValueCharFilter(field_name="track__track", lookup_expr='iexact')
    residential_colleges = MultiValueCharFilter(field_name="residential_college__residential_college",
                                               lookup_expr='iexact')
    concentrations = MultiValueCharFilter(field_name="concentration__concentration", lookup_expr='iexact')
    housing_buildings = MultiValueCharFilter(field_name='housing__building', lookup_expr='iexact')
    housing_locations = MultiValueCharFilter(field_name='housing__entire_location_string', lookup_expr='iexact')
    ...
    extracurricular_positions = MultiValueCharFilter(field_name='extracurricular_position_objs__position',
                                                     lookup_expr='iexact')
    # extracurricular_subgroups = MultiValueCharFilter(field_name='extracurricular_objs__subgroup', lookup_expr='iexact')
    research_types = MultiValueCharFilter(field_name='research_objs__research_type', lookup_expr='iexact')
