...
#                 if not OITActiveDirectoryUserInfo.objects.filter(net_id=net_id, full_name=full_name, puid=puid,
#                                                                  email=email,
...
#                     OITActiveDirectoryUserInfo.objects.create(net_id=net_id, full_name=full_name, puid=puid,
#                                                               email=email,
#                                                               interoffice_address=interoffice_address,
