                ...
                <Menu.Items
                    ...
                    <div className="px-1 py-1 ">
                        ...
                        {hasProfile && <Menu.Item>
                            {({active}) => (
                                <div
                                    onClick={async () => await router.push(`/profile/preview`)}
                                    className={`${
                                        active ? 'bg-primary-300 text-white' : 'text-gray-900'
                                    } group flex w-full items-center rounded-md px-2 py-2 text-sm cursor-pointer`}
                                >
                                    {active ? (
                                        <ProfilePreviewActiveIcon
                                            className="mr-2 h-5 w-5 pr-2"
                                            aria-hidden="true"
                                        />
                                    ) : (
                                        <ProfilePreviewInactiveIcon
                                            className="mr-2 h-5 w-5 pr-2"
                                            aria-hidden="true"
                                        />
                                    )}
...
function ProfilePreviewActiveIcon(props) {
    return (
        <svg {...props} xmlns="http://www.w3.org/2000/svg"
             fill="#E77500"
             stroke="#FFC68B"
             viewBox="0 0 24 24" strokeWidth={1.5}  className="w-6 h-6">
...
function ProfilePreviewInactiveIcon(props) {
    return (
        <svg {...props} xmlns="http://www.w3.org/2000/svg"
             fill="#E77500"
             stroke="#FFC68B"
